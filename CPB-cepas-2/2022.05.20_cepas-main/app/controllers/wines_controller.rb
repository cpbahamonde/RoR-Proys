class WinesController < ApplicationController
  ...
  def new
    ...
    @wine.wine_oenologists.build
    @eonologists = Oenologist.all.order(age: :asc)
  end
  ...
  private
    ...
    def wine_params 
      params.require(:wine).permit(:name,:score, wine_strains_attributes: [:id, :strain_id, :percentage, :_destroy], wine_oenologists_attributes: [:id, :oenologist_id, :score, :_destroy])
    end
end
