class PetHistoriesController < ApplicationController
  ...
  def create
    ...
    @pet_history.holder_id = @pet_history.pet.holder_id 
    respond_to do |format|
      if @pet_history.save
        format.html { redirect_to pet_history_url(@pet_history), notice: "Control creado exitosamente" }
  ...
  def update
    respond_to do |format|
      if @pet_history.update(pet_history_params)
        format.html { redirect_to pet_history_url(@pet_history), notice: "Control modificado exitosamente" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pet_histories_url, notice: "Control eliminado exitosamente" }
  ...
  private
    ...
    def pet_history_params
      params.require(:pet_history).permit(:weight, :height, :description, :holder_id, :pet_id)
    end
end
