...
ActiveRecord::Schema[7.0].define(version: 2022_05_28_053419) do
  ...
  create_table "pet_histories", force: :cascade do |t|
    ...
    t.index ["holder_id"], name: "index_pet_histories_on_holder_id"
  ...
  add_foreign_key "pet_histories", "holders"
