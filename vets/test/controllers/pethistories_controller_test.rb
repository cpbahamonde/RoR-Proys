...
class PethistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pethistory" do
    assert_difference("Pethistory.count") do
      post pethistories_url, params: { pethistory: { diagnostic: @pethistory.diagnostic, height: @pethistory.height, weight: @pethistory.weight } }
    end
  ...
  test "should update pethistory" do
    patch pethistory_url(@pethistory), params: { pethistory: { diagnostic: @pethistory.diagnostic, height: @pethistory.height, weight: @pethistory.weight } }
