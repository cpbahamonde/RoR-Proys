class HoldersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @holder.save
        format.html { redirect_to holder_url(@holder), notice: "Dueño fue creado exitosamente" }
  ...
  def update
    respond_to do |format|
      if @holder.update(holder_params)
        format.html { redirect_to holder_url(@holder), notice: "Dueño fue actualizado exitosamente" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to holders_url, notice: "Dueño fue eliminado exitosamente" }
  ...
  private
    ...
    def holder_params
      params.require(:holder).permit(:name, :phone, :address, :email, :pet_id)
    end
end
